...
# Create risk score for ordering clusters
...
for category in ["At-Risk", "Average", "Good"]:
...
plt.title("Student Performance Risk Clustering (K-Means, k=3)")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
joblib.dump(kmeans, "ml/student_clustering_model_k3.pkl")
joblib.dump(scaler, "ml/feature_scaler_k3.pkl")

print("\nK=3 clustering model and scaler saved successfully.")
